...
const images = [
  ...
  process.env.PUBLIC_URL + "/my-first-project/Gallery/31pic.jpg",
  process.env.PUBLIC_URL + "/my-first-project/Gallery/32pic.jpg",
  process.env.PUBLIC_URL + "/my-first-project/Gallery/33pic.jpg",
  process.env.PUBLIC_URL + "/my-first-project/Gallery/34pic.jpg",
  process.env.PUBLIC_URL + "/my-first-project/Gallery/35pic.jpeg",
  process.env.PUBLIC_URL + "/my-first-project/Gallery/36pic.jpg",
  process.env.PUBLIC_URL + "/my-first-project/Gallery/37pic.jpeg",
  process.env.PUBLIC_URL + "/my-first-project/Gallery/38pic.jpg",
  process.env.PUBLIC_URL + "/my-first-project/Gallery/39pic.jpg",
  process.env.PUBLIC_URL + "/my-first-project/Gallery/40pic.jepg",
];
